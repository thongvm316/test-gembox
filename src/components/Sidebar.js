        ...
        <Layout.Sider style={{ background: '#414955', height: 'auto' }} className="sidebar-left-menu" collapsedWidth="0" trigger={null} collapsible collapsed={collapsed}>
            <Menu theme='dark' style={{ background: '#414955' }} mode="inline" defaultSelectedKeys={['1']}>
                ...
                <Menu.Item className="app-menu-item" key="/page2">
                    <NavLink to="/product-search"><Image src={Search} style={{ marginRight: '11px' }} />상품 검색</NavLink>
                </Menu.Item>
                <Menu.Item className="app-menu-item" key="/page3">
                    <NavLink to="/vendor-search"><Image src={Vendorsearch} style={{ marginRight: '11px' }} />밴더 검색</NavLink>
                </Menu.Item>
                <Menu.Item className="app-menu-item" key="/page5">
                    <NavLink to="/sale-status"><Image src={Chart} style={{ marginRight: '11px' }} />나의 판매 현황</NavLink>
                </Menu.Item>
            </Menu>
        </Layout.Sider>
    )
