						...
						<Form onFinish={onFinish}>
							...
							>
								<Input
									...
									suffix={
										<Button onClick={verifySmsCode} className='send-sms' type='text'>
							...
							{inputs.inputs.map((input, index) => (
								<Input
									...
									suffix={
										<Button style={{ borderColor: '#A6B0CF' }} onClick={appendInput}>
											+
										</Button>
									}
								/>
							...
							>
								<Checkbox>
									<span style={{ color: 'red', fontWeight: 'bold' }}>(필수)</span>{' '}
									<span style={{ fontWeight: 'bold' }}>개인정보 수집 및 이용</span>
								</Checkbox>
							</Form.Item>
							<div className='agreement'>
								<p>
									<span style={{ color: '#A6B0CF' }}>■</span> 수집하는 개인정보 항목회사는 회원가입, 상담, 서비스 신청 등등을 위해
									아래와 같은 개인정보를 수집하고 있습니다.ο 수집항목 : 이름, 업체명 , 비밀번호, 휴대폰 번호 , 이메일 , 사업자등록증, 법정대리인정보 , 서비스
									이용기록 , 접속 로그 , 접속 IP 정보ο 개인정보 수집방법 : 홈페이지(회원가입) , 서면양식
								</p>
								<p>
									<span style={{ color: '#A6B0CF' }}>■</span> 개인정보의 수집 및 이용목적 회사는 수집한 개인정보를 다음의 목적을 위해
									활용합니다. ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산 콘텐츠 제공 , 구매 및 요금 결제 , 물품배송 또는 청구지 등 발송ο
									회원 관리회원제 서비스 이용에 따른 본인확인 , 개인 식별, 고지사항 전달 ο 마케팅 및 광고에 활용접속 빈도 파악 또는 회원의 서비스 이용에 대한
									통계
								</p>
								<p>
									<span style={{ color: '#A6B0CF' }}>■</span> 개인정보의 보유 및 이용기간 회사는 개인정보 수집 및 이용목적이 달성된
				...
				<div className='modal-signup'>
					<Row gutter={24} align='middle' style={{ flexDirection: 'column' }}>
						...
						<Col span={15}>
							...
							>
								관리자 승인 후 사용가능합니다승인 완료시 등록하신 이메일로 안내 메일 보내드리겠습니다
							</p>
						</Col>
						<Col span={24}>
							<Button
