    ...
    return (
        <div className="signup">
            ...
            <Row gutter={24} justify="center">
                <Col xs={24} sm={24} md={18} lg={18} xl={12} style={{ display: 'flex', justifyContent: 'center' }}>
                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                        ...
                        >
                            ...
                            <div className="verified">
                                ...
                                <Button onClick={verifySmsCode}>{resendSms ? resendSms : '인증번호 전송'}</Button>
                            </div>
                            {
                                verifiedPhone ?
                                    <FormItem
                            ...
                            <div className="agreement">
                                <p>■ 수집하는 개인정보 항목회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.ο 수집항목 : 이름, 업체명 , 비밀번호, 휴대폰 번호 , 이메일 , 사업자등록증, 법정대리인정보 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보ο 개인정보 수집방법 : 홈페이지(회원가입) , 서면양식</p>
                                <p> ■ 개인정보의 수집 및 이용목적
                            ...
                            <Row gutter={24} justify="center">
                                <Col span={16} style={{ textAlign: 'center', marginTop: '24px' }}>
                                    <FormItem>
            ...
            <Row gutter={24}>
                <Col span={24} style={{ textAlign: 'center', marginTop: '143px' }}>
                    <Button onClick={onFindPassword} style={{ marginBottom: '20px' }}>비밀번호 찾기</Button>
                    <h4>오직 잼팩토리와 협약된 계정만 사용가능합니다</h4>
                </Col>
            </Row>

            <Row justify='center' className="footer" style={{ marginTop: '50px', textAlign: 'center' }}>
                <Col span={20}>
